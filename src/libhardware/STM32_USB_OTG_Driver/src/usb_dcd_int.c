...
/* Interrupt Handlers */
uint32_t DCD_HandleInEP_ISR(USB_OTG_CORE_HANDLE *pdev);
uint32_t DCD_HandleOutEP_ISR(USB_OTG_CORE_HANDLE *pdev);
...
uint32_t DCD_OTG_ISR(USB_OTG_CORE_HANDLE *pdev);
#endif
