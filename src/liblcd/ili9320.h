...
void GUI_Line(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color);  // 画线
void GUI_Circle(uint16_t cx, uint16_t cy, uint16_t r, uint16_t color, uint8_t fill);  // 画园
void GUI_Rectangle(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint8_t fill); // 画矩形
void GUI_Square(uint16_t x0, uint16_t y0, uint16_t with, uint16_t color, uint8_t fill);  // 画正方形
